...
class SelectDictionaryForTestController: UIViewController {
    ...
    init() {
        super.init(nibName: "SelectDictionaryForTestController", bundle: nil)
...
extension SelectDictionaryForTestController: UIPickerViewDataSource, UIPickerViewDelegate{
