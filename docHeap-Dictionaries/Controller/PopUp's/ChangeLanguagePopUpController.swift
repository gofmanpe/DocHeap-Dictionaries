...
class ChangeLanguagePopUpController: UIViewController {
    ...
    init() {
        super.init(nibName: "ChangeLanguagePopUpController", bundle: nil)
...
extension ChangeLanguagePopUpController: UIPickerViewDataSource, UIPickerViewDelegate{
