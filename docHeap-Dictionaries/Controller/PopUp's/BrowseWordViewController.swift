...
class BrowseWordViewController: UIViewController {
 ...
 //   var wrongAnswers = Int()
    ...
    init() {
        super.init(nibName: "BrowseWordViewController", bundle: nil)
...
extension BrowseWordViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
