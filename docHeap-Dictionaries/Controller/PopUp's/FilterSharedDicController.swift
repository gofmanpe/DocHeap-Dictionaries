...
class FilterSharedDicController: UIViewController {
    ...
    init() {
        super.init(nibName: "FilterSharedDicController", bundle: nil)
    ...
    func appear(sender: NetworkViewController) {
...
extension FilterSharedDicController: UIPickerViewDelegate,UIPickerViewDataSource{
