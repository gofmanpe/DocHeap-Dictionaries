...
class BrowseSharedWordViewController: UIViewController {
    ...
    init() {
        super.init(nibName: "BrowseSharedWordViewController", bundle: nil)
    ...
    func appear(sender: BrowseSharedDicViewController) {
